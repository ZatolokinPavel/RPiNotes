...
## План
1. Установить операционную систему Raspberry Pi OS Lite. [(обязательно см. ниже)](#Установка-операционной-системы)
...
11. (нет) Добавить репозиторий **bullseye**. [(см. ниже)](#Добавление-репозитория-bullseye)
12. [Настроить часы реального времени.](RTC.md)
13. [Настроить watchdog.](Watchdog.md)
14. (sh) Отключить Wi-Fi и Bluetooth [(см. ниже)](#Отключение-Wi-Fi-и-Bluetooth)
15. (sh) Применить дополнительные настройки [(см. ниже)](#Дополнительные-настройки)
