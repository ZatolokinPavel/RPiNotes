...
5. Выполнить [скрипт настройки](#Скрипт-настройки). Все последующие пункты с пометкой (sh) не выполнять - они есть в скрипте.
6. Обновить всё что только можно [(см. ниже)](#Обновление)
7. (sh) Установка необходимого минимума программ [(см. ниже)](#Установка-необходимого-минимума-программ)
8. [Настроить SSH доступ и локальную сеть.](SSH.md)
9. [Настроить пользователей системы.](Users.md)
10. [Установить и настроить Samba для создания общей папки.](Samba.md)
11. Добавить репозиторий **bullseye**. [(см. ниже)](#Добавление-репозитория-bullseye)
...
19. [Установить и настроить PostgreSQL](PostgreSQL.md)
...
```shell
cd
wget https://raw.githubusercontent.com/ZatolokinPavel/RPiNotes/master/configure_rpi.sh
