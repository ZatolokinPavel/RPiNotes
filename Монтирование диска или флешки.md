# Монтирование дополнительного диска на карте памяти

Тут кратко те же инструкции, что описаны ниже для флешки, но с поправкой на диск и без описания и ссылок на источники.  
